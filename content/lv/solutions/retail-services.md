---
title: "Kases sistēmas un POS"
description: "Gatavi POS risinājumi «zem atslēgas» veikaliem, kafejnīcām un skaistumkopšanas saloniem. Pilnīga atbilstība VID prasībām."
layout: "retail-services"

hero:
  subtitle: "Sertificētas kases sistēmas tirdzniecībai un pakalpojumiem"
  description: "Nodrošiniet sava uzņēmuma efektivitātei modernu un drošu tirdzniecības risinājumu. Mēs piedāvājam pilnībā nokomplektētas VID sertificētas kases sistēmas un POS aprīkojumu, kas palīdzēs Jums pilnvērtīgi vadīt pārdošanas procesus un uzskaiti. Izvēlieties gatavu komplektu «viss iekļauts» — no jaudīga monobloka līdz pilnīgai integrācijai ar Jūsu izvēlēto programmatūru un maksājumu ierīcēm."
  image: "/images/solutions/pos-monobloks.png"

features_section:
  title: "Ko Jūs iegūstat, izvēloties mūsu komplektus?"
  items:
    ...
    - icon: "las la-code"
      ...
      text: "Pilna integrācija ar modernām POS programmām (tostarp mūsu specializēto ALPOS sistēmu) un noliktavas uzskaiti."
    - icon: "las la-plus-circle"
      title: "Papildus aprīkojums"
      text: "Iespēja pieslēgt jebkuras perifērijas ierīces: elektroniskie svari, svītrkodu lasītājs, čeku printeris un kases kaste."
