...
# banner
banner:
  title: "Современные кассовые и POS-системы для Вашего бизнеса"
...
top_products:
  ...
  products:
    - image: "images/banner-app1.png"
      ...
      price: "19.99 EUR"
      link: "/ru/product/monoblocks/1"
    - image: "images/banner-app1.png"
      title: "Product 2"
      content: "Описание будет здесь"
      price: "19.99 EUR"
      link: "/ru/product/monoblocks/2"
    - image: "images/banner-app1.png"
      title: "Product 2"
      content: "Описание будет здесь"
      price: "19.99 EUR"
...
business_directions:
  ...
  description: "Обеспечиваем всё необходимое для эффективности Вашей компании — от сертифицированных чековых принтеров до умного складского ПО."
  directions_blocks:
    - icon: "las la-key"
      ...
      features_list:
        ...
        - "Мобильные чековые принтеры и бесконтактные платежные терминалы"
    ...
    - icon: "las la-cash-register"
      ...
      button_text: "Узнать больше"
      features_list:
        - "Сертифицированные дисплеи покупателя, принтеры чеков и денежные ящики"
